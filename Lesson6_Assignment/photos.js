...
function populateFigures(){
  var filename;
  var currentFig; // end of populateFigures()
...
//create event listeners for left arrow, fight arrow, and center figure element 
function createEventListeners() {
  ...
  if (rightarrow.addEventListener){
    rightarrow.addEventListener("click", rightArrow, false);
           ...
           rightarrow.attachEvent("onlick", rightArrow);
